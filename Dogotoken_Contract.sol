 ...
 * #DOGO 
 * Website :  http://www.DOGOtoken.com/
 * 
 * #DOGO is made to be fully transferred to its beloved community.
 * 
 * #DOGO community is completely organic and will work hard as a community to make each member crypto-rich.
 * 
 ...
 * 
 * ( Marketing wallet is transparent and used only for the development and marketing of the project for the benefit and growth of the $DOGO community )
 * 
 * 
 ...
 * We are not affiliated with any other groups, projects or teams. We are the original $DOGO team.
...
contract DOGO is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xA2170898629DCaD89967AC59628dD74C07b8C1e0;
